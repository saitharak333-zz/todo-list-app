    ...
    onSubmit(values) {
        ...
        TodoService.addTodo(username, {
            ...
            "deadline": "13-05-19",
                ...
                // username: username,
                // description: values.description,   
                // deadline: toString(values.deadline),
            }).then(
            () => (
...
//         let username = AuthService.getUsername();
//         console.log(values);
//         TodoService.addTodo(username, values.description, values.deadline).then(
//             () => (
//                 this.props.history.push(`/app/todos`)
//             ))
//         } 
//         else {
//             console.log("Entered update todo")
//         let username = AuthService.getUsername();
//         console.log(values);
//         TodoService.updateTodo(username, this.state.id, values.description, values.deadline).then(
//             response => (
//                 this.props.history.push(`/app/todos`)
//         ))
//     }
